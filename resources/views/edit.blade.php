        ...
        <form method="post" action="{{action('CRUDController@update', $id)}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control form-control-lg" id="lgFormGroupInput" placeholder="description" name="description" value="{{$crud->description}}">                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control form-control-lg" id="lgFormGroupInput" placeholder="writer" name="writer" value="{{$crud->writer}}">                </div>
            </div>
